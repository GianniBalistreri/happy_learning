...
Q_TABLE_PARAM_SPACE_CLF: dict = dict(ada=dict(n_estimators_very_low=tuple([5, 10]),
                                              n_estimators_low=tuple([11, 50]),
                                              n_estimators_medium=tuple([51, 100]),
                                              n_estimators_high=tuple([101, 200]),
                                              n_estimators_very_high=tuple([201, 500]),
                                              learning_rate_very_low=tuple([0.01, 0.09]),
                                              learning_rate_low=tuple([0.09, 0.2]),
                                              learning_rate_medium=tuple([0.2, 0.4]),
                                              learning_rate_high=tuple([0.4, 0.7]),
                                              learning_rate_very_high=tuple([0.7, 1.0])
                                              ),
                                     cat=dict(n_estimators_very_low=tuple([5, 10]),
                                              n_estimators_low=tuple([11, 20]),
                                              n_estimators_medium=tuple([21, 50]),
                                              n_estimators_high=tuple([51, 100]),
                                              n_estimators_very_high=tuple([101, 200]),
                                              learning_rate_very_low=tuple([0.01, 0.09]),
                                              learning_rate_low=tuple([0.09, 0.2]),
                                              learning_rate_medium=tuple([0.2, 0.4]),
                                              learning_rate_high=tuple([0.4, 0.7]),
                                              learning_rate_very_high=tuple([0.7, 1.0]),
                                              l2_leaf_reg_very_low=tuple([0.1, 0.15]),
                                              l2_leaf_reg_low=tuple([0.15, 0.2]),
                                              l2_leaf_reg_medium=tuple([0.2, 0.4]),
                                              l2_leaf_reg_high=tuple([0.4, 0.7]),
                                              l2_leaf_reg_very_high=tuple([0.7, 1.0]),
                                              depth_very_low=tuple([3, 4]),
                                              depth_low=tuple([5, 6]),
                                              depth_medium=tuple([7, 9]),
                                              depth_high=tuple([10, 13]),
                                              depth_very_high=tuple([14, 16]),
                                              sampling_frequency=['PerTree', 'PerTreeLevel'],
                                              grow_policy=['SymmetricTree', 'Depthwise', 'Lossguide'],
                                              min_data_in_leaf_very_low=tuple([1, 2]),
                                              min_data_in_leaf_low=tuple([3, 4]),
                                              min_data_in_leaf_medium=tuple([5, 10]),
                                              min_data_in_leaf_high=tuple([11, 15]),
                                              min_data_in_leaf_very_high=tuple([16, 20]),
                                              rsm_very_low=tuple([0, 0.1]),
                                              rsm_low=tuple([0.1, 0.2]),
                                              rsm_medium=tuple([0.2, 0.6]),
                                              rsm_high=tuple([0.6, 0.8]),
                                              rsm_very_high=tuple([0.8, 1.0]),
...
Q_TABLE_PARAM_SPACE_REG: dict = dict(ada=dict(n_estimators_0=tuple([5, 9]),
                                              ...
                                              #base_estimator=['linear', 'square', 'exponential'],
